...
Bagging trees classification using 2D texture features
============
...
```{r 2Dtex-bagg, fig.width=12, fig.height=12, warning=FALSE}
...
for(k in 1:10){  # 1:10f cv
  ...
  wpredT1T2train$find_t2_signal_int = as.factor(wpredT1T2train$find_t2_signal_int)
  ...
  save.image(paste0("Outputs/NH_addeddiagvalue_2Dtexbagg_cv",k,".RData"))
