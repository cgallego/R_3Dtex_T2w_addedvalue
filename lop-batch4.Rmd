...
```{r setup4}
knitr::opts_chunk$set(cache=TRUE, cache.path = "batch4_cache/", fig.path="batch4_figure/")
...
```{r lop-batch4, fig.width=12, fig.height=12, warning=FALSE}

# perform leave-one-patient-out LMSIR prediction
for(k in 226:300){  # 1:npatients
  ...
  save.image("Outputs/CADT2_addeddiagvalue_lop_batch4.RData")
}
...
plot batch4 results
=================================
```{r lop-batch4-plots, fig.width=12, fig.height=12, warning=FALSE}
