...
```{r setup3}
knitr::opts_chunk$set(cache=TRUE, cache.path = "batch3_cache/", fig.path="batch3_figure/")
...
```{r lop-batch3, fig.width=12, fig.height=12, warning=FALSE}

# perform leave-one-patient-out LMSIR prediction
for(k in 151:225){  # 1:npatients
  ...
  save.image("Outputs/CADT2_addeddiagvalue_lop_batch3.RData")
}
...
plot batch3 results
=================================
```{r lop-batch3-plots, fig.width=12, fig.height=12, warning=FALSE}
