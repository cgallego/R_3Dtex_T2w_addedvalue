...
```{r setup6}
knitr::opts_chunk$set(cache=TRUE, cache.path = "batch6_cache/", fig.path="batch6_figure/")
...
```{r lop-batch6, fig.width=12, fig.height=12, warning=FALSE}

# perform leave-one-patient-out LMSIR prediction
for(k in 376:npatients){  # 1:npatients
  ...
  save.image("Outputs/CADT2_addeddiagvalue_lop_batch6.RData")
}
...
plot batch6 results
=================================
```{r lop-batch6-plots, fig.width=12, fig.height=12, warning=FALSE}
